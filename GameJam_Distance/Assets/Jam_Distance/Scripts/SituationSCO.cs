...
public class SituationSCO : ScriptableObject
{
    ...
    {
        character.hat = spriteLib.GetRandomHairs();
        character.hair = spriteLib.GetRandomHairs();
        character.mask = spriteLib.GetRandomMask();
        character.bear = spriteLib.GetRandomBear();
        character.outfit = spriteLib.GetRandomOutfits();
    }
